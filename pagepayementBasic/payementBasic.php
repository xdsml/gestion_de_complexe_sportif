...
if (isset($_POST["boutton"])) {
  try {
    ...
    $query4 = "SELECT Idabonnement FROM abonnement WHERE Duree = :abonnement and Typeabonnement = :basic";
  ...
  header("location:/aprcnxx.html");
  exit;
}

        // Deuxième requête d'insertion pour l'abonnement en utilisant l'ID de l'abonné
    //     $query1 = "INSERT INTO abonnement (IdAbonnement, Typeabonnement, Duree, Prix) VALUES (:idAbonne, :choixA, :string0, :string1)";
    //     $stmt1 = $conn->prepare($query1);
    //     $stmt1->bindValue(':idAbonne', $idAbonne);
    //     $stmt1->bindValue(':choixA', $choixA);
    //     $stmt1->bindValue(':string0', $string);
    //     $stmt1->bindValue(':string1', $stringp);
    //     $stmt1->execute();

    //     // Troisième requête d'insertion pour l'activité
    //     $query3 = "INSERT INTO activite (Nomactivite) VALUES (:choixAc)";
    //     $stmt3 = $conn->prepare($query3);
    //     $stmt3->bindValue(':choixAc', $choixAc);
    //     $stmt3->execute();

    //     // Redirection après les insertions réussies
    //     header("Location: pagepayementBasic/payement.php");
    //     exit;
    // } catch (PDOException $e) {
    //     echo "Erreur lors de l'exécution de la requête SQL : " . $e->getMessage();
    // } catch (Exception $e) {
